...
# About.create( column_1: "Teater (namn) är en helt nystartad teater och vänder sig till både barn och vuxna.. Pjäserna är specialskrivna för teatern och integrerar oftast publiken på olika sätt. Teaterns mål är att alltid vara lätt tillgänglig och för alla. Det är två inplanerade produktioner under 2017 en barn teater under vinter/våren och en familjeföreställning i form av vandringsteater på sommaren. Spelplatserna varierar beroende på föreställning.",
#               column_2: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id dolorem nulla earum autem, dolor rerum illo velit veniam, quam neque, recusandae fugiat voluptates optio dignissimos odit debitis iste inventore a magni quis, ipsum aliquid. Quibusdam nam modi error quasi blanditiis veniam dolorem pariatur velit sunt. Harum dignissimos, laborum quibusdam. Aliquam!",
#               column_3: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus odio pariatur repudiandae eos vel, porro nequt excepturi minus vel officiis voluptates minima repellat, eos laudantium sequi nesciunt. Ducimus, veniam, porro!",
#               title: "Om teatern",
#               image: "anja.png" )


# CoOperation.create( column_1: "Teater (namn) är en helt nystartad teater och vänder sig till både barn och vuxna.. Pjäserna är specialskrivna för teatern och integrerar oftast publiken på olika sätt. Teaterns mål är att alltid vara lätt tillgänglig och för alla. Det är två inplanerade produktioner under 2017 en barn teater under vinter/våren och en familjeföreställning i form av vandringsteater på sommaren. Spelplatserna varierar beroende på föreställning.",
#               column_2: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id dolorem nulla earum autem, dolor rerum illo velit veniam, quam neque, recusandae fugiat voluptates optio dignissimos odit debitis iste inventore a magni quis, ipsum aliquid. Quibusdam nam modi error quasi blanditiis veniam dolorem pariatur velit sunt. Harum dignissimos, laborum quibusdam. Aliquam!",
#               title: "Om teatern",
#               image: "example.png" )

# Course.create( column_1: "Teater (namn) är en helt nystartad teater och vänder sig till både barn och vuxna.. Pjäserna är specialskrivna för teatern och integrerar oftast publiken på olika sätt. Teaterns mål är att alltid vara lätt tillgänglig och för alla. Det är två inplanerade produktioner under 2017 en barn teater under vinter/våren och en familjeföreställning i form av vandringsteater på sommaren. Spelplatserna varierar beroende på föreställning.",
#               column_2: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id dolorem nulla earum autem, dolor rerum illo velit veniam, quam neque, recusandae fugiat voluptates optio dignissimos odit debitis iste inventore a magni quis, ipsum aliquid. Quibusdam nam modi error quasi blanditiis veniam dolorem pariatur velit sunt. Harum dignissimos, laborum quibusdam. Aliquam!",
#               title: "Om teatern" )
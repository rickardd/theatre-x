...
class AboutsControllerTest < ActionController::TestCase
  ...
  test "should create about" do
    assert_difference('About.count') do
      post :create, about: { column_1: @about.column_1, column_2: @about.column_2, column_3: @about.column_3, image: @about.image, title: @about.title }
    end
  ...
  test "should update about" do
    patch :update, id: @about, about: { column_1: @about.column_1, column_2: @about.column_2, column_3: @about.column_3, image: @about.image, title: @about.title }
    assert_redirected_to about_path(assigns(:about))
  end
